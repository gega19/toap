...
// in toap/test/features/todo/bloc/todo_bloc_test.dart.
...
import 'package:toap/features/todo/domain/domain.dart' as _i2;
...
class MockGetTasks extends _i1.Mock implements _i2.GetTasks {
  MockGetTasks() {
...
class MockAddTaskUseCase extends _i1.Mock implements _i2.AddTaskUseCase {
  ...
  @override
  _i3.Future<_i2.Task> call(_i2.Task? task) => (super.noSuchMethod(
        Invocation.method(
          #call,
          [task],
        ),
        returnValue: _i3.Future<_i2.Task>.value(_FakeTask_1(
          this,
          Invocation.method(
            #call,
            [task],
...
class MockDeleteTaskUseCase extends _i1.Mock implements _i2.DeleteTaskUseCase {
  ...
  @override
  _i3.Future<void> call(_i2.Task? task) => (super.noSuchMethod(
        Invocation.method(
          #call,
          [task],
        ),
...
/// A class which mocks [ToggleTaskStatusUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockToggleTaskStatusUseCase extends _i1.Mock
    implements _i2.ToggleTaskStatusUseCase {
  MockToggleTaskStatusUseCase() {
    _i1.throwOnMissingStub(this);
  }
